...
%
% This file implements the right hand side of the ODE with two strains of 
% cells in the same environment. Model variables doubled, except 
% extracellular nutrients to study dynamics of a competing, more dominant
% strain.


%%
function dydt= cellmodel_odes_2_edit(t, y, rates, parameters)
	...
	dydt(24)= +nuimp2-nucat2-lam2*si2;  % si2
